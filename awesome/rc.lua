...
local function battery_read()
	...
	local bat_cap = f_capacity:read("*all")
	local bat_status = trim(f_status:read("*all"))

	if(bat_status == 'Discharging') then 
		batteryWidget.markup = '  <span foreground="red">'..bat_cap..'</span>'
	else
		batteryWidget.markup = '  <span foreground="green">'..bat_cap..'</span>'
	end
end

battery_read()
battimer = timer({timeout = 15})
battimer:connect_signal("timeout", battery_read)
battimer:start()
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume", function() awful.util.spawn("pamixer -i 10") end),
